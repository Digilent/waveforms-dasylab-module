...
cmd /c mklink /d "C:/Program Files (x86)/DASYLab 2022_en/python/Lib/site-packages/debugpy" "C:\git\digilent\sw-waveforms-dasylab-module\python_dependencies\debugpy"
...
cmd /c mklink /d "C:\Program Files (x86)\DASYLab 2022_en\pool\files\digilent_waveforms_dasylab" "C:\git\digilent\sw-waveforms-dasylab-module\digilent_waveforms_dasylab"
